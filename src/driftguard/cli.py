...
exps = Exps(
    ...
    strategies=[
        # Never(),
        AveTrig(thr_acc=0.6, data_port=12101, server_port=12102),
        PerCTrig(thr_acc=0.6, data_port=12201, server_port=12202),
        MoEAve(thr_acc=0.6, data_port=12301, server_port=12302),
        MoEPerC(thr_acc=0.6, data_port=12401, server_port=12402),
        Cluster(thr_acc=0.6, data_port=12501, server_port=12502),
        Driftguard(thr_group_acc=0.6, data_port=12601, server_port=12602),
