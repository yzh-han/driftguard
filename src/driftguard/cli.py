...
exps = Exps(
    ...
    strategies=[
        # Never(),
        AveTrig(thr_acc=0.75, data_port=13101, server_port=13102),
        PerCTrig(thr_acc=0.75, data_port=13201, server_port=13202),
        MoEAve(thr_acc=0.75, data_port=13301, server_port=13302),
        MoEPerC(thr_acc=0.75, data_port=13401, server_port=13402),
        Cluster(thr_acc=0.75, data_port=13501, server_port=13502),
        Driftguard(thr_group_acc=0.75, data_port=13601, server_port=13602),
